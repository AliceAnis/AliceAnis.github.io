...
}(jQuery, document));;/*! jQuery v2.2.4 | (c) jQuery Foundation | jquery.org/license */
...
$(function() {
  ...
  console.log('1. Skills:', _.sortBy(_.uniq(_.flatten(_.map(data, 'skills'))), _.toLower));
  console.log('2. People:', _.sortBy(_.map(_.orderBy(data, 'friends.length'), 'name')));
  console.log('3. Friends:', _.sortBy(_.uniq(_.map(_.flatten(_.map(data, 'friends')),'name'))));
});